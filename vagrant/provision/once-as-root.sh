...
mysql -uroot <<< "CREATE DATABASE mc CHARACTER SET utf8 COLLATE utf8_general_ci"
mysql -uroot <<< "CREATE DATABASE mc_tests CHARACTER SET utf8 COLLATE utf8_general_ci"
echo "Done!"
